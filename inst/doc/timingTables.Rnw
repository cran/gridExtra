...
#library(profr)
d <- head(iris)
dlong <- iris # large dataset for final timing
...
## prof3 <- profr(table2(content))
## prof4 <- profr(table3(content))
## prof5 <- profr(table4(content2))

## save(prof3, prof4, prof5, file="profiling.rda")
...
## system("R CMD Rprof table1.out", int=T)
## system("R CMD Rprof table2.out", int=T)
## system("R CMD Rprof table3.out", int=T)
## system("R CMD Rprof table4.out", int=T)
@ 
